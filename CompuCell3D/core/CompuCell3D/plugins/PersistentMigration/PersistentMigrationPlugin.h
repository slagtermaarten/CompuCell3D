#ifndef COMPUCELL3DPERSISTENTMIGRATIONPLUGIN_H
#define COMPUCELL3DPERSISTENTMIGRATIONPLUGIN_H
...
#include "PersistentMigrationDLLSpecifier.h"
...
namespace CompuCell3D {
  ...
  class PERSISTENTMIGRATION_EXPORT PersistentMigrationParam{
  public:
	  PersistentMigrationParam(){
		  lambdaVec.x=0.0;
		  lambdaVec.y=0.0;
		  lambdaVec.z=0.0;
	  }
	...
	class PERSISTENTMIGRATION_EXPORT PersistentMigrationPlugin : public Plugin,public EnergyFunction
	{
    ...
    Dim3D fieldDim;
	 ...
	 std::vector<PersistentMigrationParam> externalPotentialParamVector;

	 typedef double (PersistentMigrationPlugin::*changeEnergy_t)(const Point3D &pt, const CellG *newCell,const CellG *oldCell);

	 PersistentMigrationPlugin::changeEnergy_t changeEnergyFcnPtr;
