...
#include "PersistentMigrationPlugin.h"

namespace CompuCell3D {

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	PersistentMigrationPlugin::PersistentMigrationPlugin():lambdaVec(Coordinates3D<float>(0.,0.,0.)),xmlData(0),boundaryStrategy(0)
{}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
PersistentMigrationPlugin::~PersistentMigrationPlugin()
{
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

void PersistentMigrationPlugin::init(Simulator *_simulator, CC3DXMLElement *_xmlData){
  ...
  potts->registerEnergyFunctionWithName(this,"PersistentMigration");
...
void PersistentMigrationPlugin::extraInit(Simulator *_simulator){
...
void PersistentMigrationPlugin::update(CC3DXMLElement *_xmlData, bool _fullInitFlag){
	...
	if(!_xmlData->getNumberOfChildren() || (_xmlData->getNumberOfChildren()==1 && _xmlData->findElement("Algorithm"))){ 
		...
		if(_xmlData->findElement("PersistentMigrationParameters"))
	...
	switch(functionType){
		case BYCELLID:
			...
			if (comBasedAlgorithm){				
				changeEnergyFcnPtr=&PersistentMigrationPlugin::changeEnergyByCellIdCOMBased;
			}else{
				changeEnergyFcnPtr=&PersistentMigrationPlugin::changeEnergyByCellId;				
			}
			break;
		...
		case BYCELLTYPE:
			{
				...
				vector<PersistentMigrationParam> externalPotentialParamVectorTmp;

				CC3DXMLElementList energyVec=_xmlData->getElements("PersistentMigrationParameters");

				for (int i = 0 ; i<energyVec.size(); ++i){
					PersistentMigrationParam extPotentialParam;
				...
				int maxTypeId=*pos;
				externalPotentialParamVector.assign(maxTypeId+1,PersistentMigrationParam());
				...
				//set fcn ptr
				if (comBasedAlgorithm){
					changeEnergyFcnPtr=&PersistentMigrationPlugin::changeEnergyByCellTypeCOMBased;					
				}else{
					changeEnergyFcnPtr=&PersistentMigrationPlugin::changeEnergyByCellType;					
				}
		...
		case GLOBAL:
			...
			//set fcn ptr
			//changeEnergyFcnPtr=&PersistentMigrationPlugin::changeEnergyGlobal;
			if (comBasedAlgorithm){								
				changeEnergyFcnPtr=&PersistentMigrationPlugin::changeEnergyGlobalCOMBased;
			}else{
				changeEnergyFcnPtr=&PersistentMigrationPlugin::changeEnergyGlobal;
			}
...
double PersistentMigrationPlugin::changeEnergyGlobalCOMBased(const Point3D &pt,  const CellG *newCell,
                                                const CellG *oldCell)
{
...
double PersistentMigrationPlugin::changeEnergyByCellTypeCOMBased(const Point3D &pt,  const CellG *newCell,
                                                const CellG *oldCell)
{
...
double PersistentMigrationPlugin::changeEnergyByCellIdCOMBased(const Point3D &pt,  const CellG *newCell,
                                                const CellG *oldCell)
{
...
double PersistentMigrationPlugin::changeEnergyGlobal(const Point3D &pt,  const CellG *newCell,
                                                const CellG *oldCell)
{
...
double PersistentMigrationPlugin::changeEnergyByCellType(const Point3D &pt,  const CellG *newCell,
                                                const CellG *oldCell)
{
...
double PersistentMigrationPlugin::changeEnergyByCellId(const Point3D &pt,  const CellG *newCell,
                                                const CellG *oldCell)
{
...
double PersistentMigrationPlugin::changeEnergy(const Point3D &pt,  const CellG *newCell,
                                                const CellG *oldCell)
{
...
std::string PersistentMigrationPlugin::toString(){
      return "PersistentMigration";
}


std::string PersistentMigrationPlugin::steerableName(){
